package fun.rich.display.screens.clickgui.components.implement.module.settings.multiselect;

import fun.rich.display.screens.clickgui.components.implement.settings.multiselect.MultiSelectedButton;
...
public class MultiSelectComponent extends AbstractSettingComponent {
    private final List<fun.rich.display.screens.clickgui.components.implement.settings.multiselect.MultiSelectedButton> multiSelectedButtons = new ArrayList<>();
    ...
    public MultiSelectComponent(MultiSelectSetting setting) {
        ...
        for (String s : setting.getList()) {
            multiSelectedButtons.add(new fun.rich.display.screens.clickgui.components.implement.settings.multiselect.MultiSelectedButton(setting, s));
        }
    }
