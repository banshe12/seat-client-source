package fun.rich.display.screens.clickgui.components.implement.module.module;

import fun.rich.display.screens.clickgui.components.implement.module.ModuleDescriptions;
import fun.rich.display.screens.clickgui.components.implement.module.ModuleSettingsWindow;
...
public class ModuleComponent extends AbstractComponent {
        ...
        for (java.lang.String word : words) {
            ...
            if (currentX + wordWidth > x + maxWidth) {
                if (currentLine == 1) {
                    ...
                    Fonts.getSize(12, DEFAULT).drawString(context.getMatrices(), line.toString(), x + 5, currentY, new Color(225, 225, 255, 186).getRGB());
                }
                line = new StringBuilder();
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (Calculate.isHovered(mouseX, mouseY, x, y, width, getComponentHeight()) && button == 1 && !module.settings().isEmpty()) {
            if (MenuScreen.windowManager.getWindows().stream().noneMatch(w -> w instanceof fun.rich.display.screens.clickgui.components.implement.module.ModuleSettingsWindow && ((fun.rich.display.screens.clickgui.components.implement.module.ModuleSettingsWindow) w).module.equals(module))) {
                fun.rich.display.screens.clickgui.components.implement.module.ModuleSettingsWindow settingsWindow = new ModuleSettingsWindow(module);
