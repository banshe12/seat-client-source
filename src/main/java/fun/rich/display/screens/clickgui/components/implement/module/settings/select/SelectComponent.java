package fun.rich.display.screens.clickgui.components.implement.module.settings.select;
...
public class SelectComponent extends AbstractSettingComponent {
    private final List<fun.rich.display.screens.clickgui.components.implement.settings.select.SelectedButton> selectedButtons = new ArrayList<>();
    ...
    public SelectComponent(SelectSetting setting) {
        ...
        for (String s : setting.getList()) {
            selectedButtons.add(new fun.rich.display.screens.clickgui.components.implement.settings.select.SelectedButton(setting, s));
        }
    }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (button == 0) {
            ...
            if (open) {
                for (fun.rich.display.screens.clickgui.components.implement.settings.select.SelectedButton selectedButton : selectedButtons) {
