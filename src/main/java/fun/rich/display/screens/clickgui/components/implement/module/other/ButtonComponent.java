...
public class ButtonComponent extends AbstractComponent {
    ...
    private int color = new Color(138, 43, 226, 255).getRGB();
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        blur.render(ShapeProperties.create(matrix, x, y, width, height).round(4).quality(12)
        ...
        rectangle.render(ShapeProperties.create(matrix, x, y, width, height)
                .round(4)
                .thickness(1.0f)
                .outlineColor(new Color(225, 225, 255, 100).getRGB())
                .color(color).build());
