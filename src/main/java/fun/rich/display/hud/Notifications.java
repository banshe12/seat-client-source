...
public class Notifications extends AbstractDraggable {
    ...
    public void setScreen(SetScreenEvent e) {
        // Redesign note: Removing debug notification.
    }
    ...
    public void drawDraggable(DrawContext context) {
        ...
        for (Notification notification : list) {
            ...
            Calculate.setAlpha(anim, () -> {
                ...
                blur.render(ShapeProperties.create(matrix, startX, startY, width + 10, getHeight() + 1).round(10).quality(12)
                        .color(new Color(0, 0, 0, 150).getRGB())
                        .build());

                rectangle.render(ShapeProperties.create(matrix, startX, startY, width + 10, getHeight() + 1).round(10)
                        .thickness(1.5f)
                ...
                if (!notification.isExpired()) {
                    ...
                    if (progressWidth > 0) {
                        rectangle.render(ShapeProperties.create(matrix, startX + 2, startY + 0.05f, progressWidth + 6, 1)
                                ...
                                .color(new Color(138, 43, 226, 255).getRGB())
                                .build());
                    }
                }
            });
