...
public class PlayerInfo extends AbstractDraggable {
    ...
    public void drawDraggable(DrawContext context) {
        ...
        blur.render(ShapeProperties.create(context.getMatrices(), getX(), getY(), getWidth(), getHeight()).round(10).quality(12)
                .color(new Color(0, 0, 0, 150).getRGB())
                .build());

        rectangle.render(ShapeProperties.create(context.getMatrices(), getX(), getY(), getWidth(), getHeight()).round(10)
                .thickness(1.5f)
