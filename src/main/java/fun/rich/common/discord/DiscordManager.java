        ...
        DiscordEventHandlers handlers = new DiscordEventHandlers.Builder()
                .ready((user) -> {
                    ...
                    DiscordRichPresence richPresence = new DiscordRichPresence.Builder()
                            ...
                            .setLargeImage("https://i.postimg.cc/nznMWbhM/0001-0250.gif", "https://stylclient.fun/")
                            .setSmallImage(Rich.getInstance().getDiscordManager().getInfo().avatarUrl, "https://stylclient.fun/")
                            .setButtons(RPCButton.create("Телеграм", "https://t.me/stylclient"),
